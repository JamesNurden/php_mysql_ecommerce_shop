...
<body>
	...
	<section class="view_container">
		<div class="heading">
			<h1>all employies</h1>
			<get src="../image/layer.png" width="100">
		</div>
		<div class="box-container">
			...
			<form action="" method="post" class="box">
				...
				<div class="content">
					...
					<div class="flex-btn">
						...
						<button type="submit" name="delete" class="btn" onclick="return confirm('want to delete this product');">delete</button>
			...
			<?php 
					...
					echo '
						<div class="empty">
							<p>no services added yet ! <br> <a href="add_employee.php" class="btn" style="margin-top: 1rem;">add employee</a> </p>
						</div>
					';
				}
			?>
